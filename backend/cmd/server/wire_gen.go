...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelPricingResolver := service.NewModelPricingResolver(channelService, billingService, modelCatalogService)
