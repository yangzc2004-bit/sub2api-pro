...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAIFillModeGroupIDs:                 settings.OpenAIFillModeGroupIDs,
...
type UpdateSettingsRequest struct {
	...
	OpenAIFillModeGroupIDs         *[]int64 `json:"openai_fill_mode_group_ids"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		OpenAIFillModeGroupIDs: func() []int64 {
			if req.OpenAIFillModeGroupIDs != nil {
				return *req.OpenAIFillModeGroupIDs
			}
			return previousSettings.OpenAIFillModeGroupIDs
		}(),
	...
	payload := dto.SystemSettings{
		...
		OpenAIFillModeGroupIDs:                 updatedSettings.OpenAIFillModeGroupIDs,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if !equalInt64Slices(before.OpenAIFillModeGroupIDs, after.OpenAIFillModeGroupIDs) {
		changed = append(changed, "openai_fill_mode_group_ids")
	}
	// 余额、订阅到期与账号限额通知
