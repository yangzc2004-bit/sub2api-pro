...
func TestAccountSupportsOpenAIEndpointCapability(t *testing.T) {
	...
	t.Run("explicit list supports chat and embeddings", func(t *testing.T) {
		account := &Account{
			Platform: PlatformOpenAI,
			Type:     AccountTypeAPIKey,
	...
	t.Run("explicit list with only chat disables embeddings", func(t *testing.T) {
		account := &Account{
			Platform: PlatformOpenAI,
			Type:     AccountTypeAPIKey,
			Credentials: map[string]any{
	...
	t.Run("explicit map can disable chat and enable embeddings", func(t *testing.T) {
		account := &Account{
			Platform: PlatformOpenAI,
			Type:     AccountTypeAPIKey,
			Credentials: map[string]any{
	...
	t.Run("unknown capability is denied by default", func(t *testing.T) {
		account := &Account{
			Platform: PlatformOpenAI,
			Type:     AccountTypeAPIKey,
		}
