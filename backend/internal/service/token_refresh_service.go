...
func NewTokenRefreshService(
	...
	for _, platformOAuthService := range platformOAuthServices {
		switch service := platformOAuthService.(type) {
		case *KimiOAuthService:
			kimiOAuthService = service
		case *GrokOAuthService:
			grokOAuthService = service
		}
	}
