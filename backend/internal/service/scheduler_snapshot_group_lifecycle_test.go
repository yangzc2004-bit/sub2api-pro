...
func TestSchedulerSnapshotPlatformsIncludeProPlatforms(t *testing.T) {
	platforms := schedulerSnapshotPlatforms()

	require.Contains(t, platforms, PlatformKimi)
	require.Contains(t, platforms, PlatformMimo)
	require.Contains(t, platforms, PlatformQwen)
	require.Contains(t, platforms, PlatformDeepSeek)
}
