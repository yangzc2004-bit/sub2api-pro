<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <button
      @click="toggleTooltip"
      class="app-top-action cursor-pointer"
      :title="t('subscriptionProgress.viewDetails')"
    >
      <Icon name="creditCard" size="sm" class="text-[var(--app-brand-strong)]" />
      <div class="flex items-center gap-1.5">
        ...
        <span class="font-display text-xs font-semibold text-[var(--app-brand-strong)]">
