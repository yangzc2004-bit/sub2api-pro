...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kimi' | 'mimo' | 'qwen' | 'deepseek'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kimi' | 'mimo' | 'qwen' | 'deepseek'
