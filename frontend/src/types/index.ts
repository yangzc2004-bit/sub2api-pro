...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kimi' | 'mimo' | 'qwen' | 'deepseek' | 'grok' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'kimi' | 'mimo' | 'qwen' | 'deepseek' | 'grok'
